...
const (
	...
	V1CustomFieldListKeysResponseEntityPackageCommit          V1CustomFieldListKeysResponseEntity = "package_commit"
	V1CustomFieldListKeysResponseEntityPackageCredit          V1CustomFieldListKeysResponseEntity = "package_credit"
	V1CustomFieldListKeysResponseEntityPackageSubscription    V1CustomFieldListKeysResponseEntity = "package_subscription"
	V1CustomFieldListKeysResponseEntityPackageScheduledCharge V1CustomFieldListKeysResponseEntity = "package_scheduled_charge"
)
...
const (
	...
	V1CustomFieldAddKeyParamsEntityPackageCommit          V1CustomFieldAddKeyParamsEntity = "package_commit"
	V1CustomFieldAddKeyParamsEntityPackageCredit          V1CustomFieldAddKeyParamsEntity = "package_credit"
	V1CustomFieldAddKeyParamsEntityPackageSubscription    V1CustomFieldAddKeyParamsEntity = "package_subscription"
	V1CustomFieldAddKeyParamsEntityPackageScheduledCharge V1CustomFieldAddKeyParamsEntity = "package_scheduled_charge"
)
...
const (
	...
	V1CustomFieldDeleteValuesParamsEntityPackageCommit          V1CustomFieldDeleteValuesParamsEntity = "package_commit"
	V1CustomFieldDeleteValuesParamsEntityPackageCredit          V1CustomFieldDeleteValuesParamsEntity = "package_credit"
	V1CustomFieldDeleteValuesParamsEntityPackageSubscription    V1CustomFieldDeleteValuesParamsEntity = "package_subscription"
	V1CustomFieldDeleteValuesParamsEntityPackageScheduledCharge V1CustomFieldDeleteValuesParamsEntity = "package_scheduled_charge"
)
...
const (
	...
	V1CustomFieldRemoveKeyParamsEntityPackageCommit          V1CustomFieldRemoveKeyParamsEntity = "package_commit"
	V1CustomFieldRemoveKeyParamsEntityPackageCredit          V1CustomFieldRemoveKeyParamsEntity = "package_credit"
	V1CustomFieldRemoveKeyParamsEntityPackageSubscription    V1CustomFieldRemoveKeyParamsEntity = "package_subscription"
	V1CustomFieldRemoveKeyParamsEntityPackageScheduledCharge V1CustomFieldRemoveKeyParamsEntity = "package_scheduled_charge"
)
...
const (
	...
	V1CustomFieldSetValuesParamsEntityPackageCommit          V1CustomFieldSetValuesParamsEntity = "package_commit"
	V1CustomFieldSetValuesParamsEntityPackageCredit          V1CustomFieldSetValuesParamsEntity = "package_credit"
	V1CustomFieldSetValuesParamsEntityPackageSubscription    V1CustomFieldSetValuesParamsEntity = "package_subscription"
	V1CustomFieldSetValuesParamsEntityPackageScheduledCharge V1CustomFieldSetValuesParamsEntity = "package_scheduled_charge"
)
