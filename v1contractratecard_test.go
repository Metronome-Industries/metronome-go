...
func TestV1ContractRateCardNewWithOptionalParams(t *testing.T) {
  ...
  _, err := client.V1.Contracts.RateCards.New(context.TODO(), metronome.V1ContractRateCardNewParams{
    Name: "My Rate Card",
    Aliases: []metronome.V1ContractRateCardNewParamsAlias{metronome.V1ContractRateCardNewParamsAlias{
      Name: "my-rate-card",
      EndingBefore: metronome.Time(time.Now()),
      StartingAt: metronome.Time(time.Now()),
    }},
    CreditTypeConversions: []metronome.V1ContractRateCardNewParamsCreditTypeConversion{metronome.V1ContractRateCardNewParamsCreditTypeConversion{
...
func TestV1ContractRateCardUpdateWithOptionalParams(t *testing.T) {
  ...
  _, err := client.V1.Contracts.RateCards.Update(context.TODO(), metronome.V1ContractRateCardUpdateParams{
    ...
    AddCreditTypeConversions: []metronome.V1ContractRateCardUpdateParamsAddCreditTypeConversion{metronome.V1ContractRateCardUpdateParamsAddCreditTypeConversion{
      CustomCreditTypeID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
      FiatPerCustomCredit: 0,
    }},
    Aliases: []metronome.V1ContractRateCardUpdateParamsAlias{metronome.V1ContractRateCardUpdateParamsAlias{
      Name: "name",
      EndingBefore: metronome.Time(time.Now()),
      StartingAt: metronome.Time(time.Now()),
    }},
...
func TestV1ContractRateCardGetRateScheduleWithOptionalParams(t *testing.T) {
  ...
  _, err := client.V1.Contracts.RateCards.GetRateSchedule(context.TODO(), metronome.V1ContractRateCardGetRateScheduleParams{
    ...
    NextPage: metronome.String("next_page"),
    EndingBefore: metronome.Time(time.Now()),
    Selectors: []metronome.V1ContractRateCardGetRateScheduleParamsSelector{metronome.V1ContractRateCardGetRateScheduleParamsSelector{
