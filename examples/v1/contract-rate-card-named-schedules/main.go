...
// getNamedSchedule retrieves a named schedule for a contract's rate card.
func getNamedSchedule(client metronome.Client) {
	resp, err := client.V1.Contracts.RateCards.NamedSchedules.Get(context.TODO(), metronome.V1ContractRateCardNamedScheduleGetParams{
...
// updateNamedSchedule updates a named schedule for a contract's rate card.
