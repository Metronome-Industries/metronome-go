...
func TestPaymentListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Payments.List(context.TODO(), metronome.PaymentListParams{
		CustomerID: "13117714-3f05-48e5-a6e9-a66093f13b4d",
		InvoiceID:  "6162d87b-e5db-4a33-b7f2-76ce6ead4e85",
		Limit:      metronome.Int(1),
		NextPage:   metronome.String("next_page"),
		Statuses:   []string{"pending", "requires_intervention"},
	})
	if err != nil {
...
func TestPaymentCancel(t *testing.T) {
	...
	_, err := client.Payments.Cancel(context.TODO(), metronome.PaymentCancelParams{
		CustomerID: "13117714-3f05-48e5-a6e9-a66093f13b4d",
		InvoiceID:  "6162d87b-e5db-4a33-b7f2-76ce6ead4e85",
	})
	if err != nil {
