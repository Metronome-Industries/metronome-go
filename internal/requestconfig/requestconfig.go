...
import (
	...
	"github.com/Metronome-Industries/metronome-go/v3/internal"
	"github.com/Metronome-Industries/metronome-go/v3/internal/apierror"
	"github.com/Metronome-Industries/metronome-go/v3/internal/apiform"
	"github.com/Metronome-Industries/metronome-go/v3/internal/apiquery"
)

func getDefaultHeaders() map[string]string {
	return map[string]string{
		"User-Agent": fmt.Sprintf("Metronome/Go %s", internal.PackageVersion),
	}
}
