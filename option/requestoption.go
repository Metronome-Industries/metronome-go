...
//
// [README]: https://pkg.go.dev/github.com/Metronome-Industries/metronome-go/v3#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.metronome.com/")
}
