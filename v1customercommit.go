...
// List commits.
func (r *V1CustomerCommitService) List(ctx context.Context, body V1CustomerCommitListParams, opts ...option.RequestOption) (res *pagination.CursorPage[shared.Commit], err error) {
...
// List commits.
func (r *V1CustomerCommitService) ListAutoPaging(ctx context.Context, body V1CustomerCommitListParams, opts ...option.RequestOption) *pagination.CursorPageAutoPager[shared.Commit] {
