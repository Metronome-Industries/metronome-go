...
func TestV1DashboardGetEmbeddableURLWithOptionalParams(t *testing.T) {
  ...
  _, err := client.V1.Dashboards.GetEmbeddableURL(context.TODO(), metronome.V1DashboardGetEmbeddableURLParams{
    ...
    BmGroupKeyOverrides: []metronome.V1DashboardGetEmbeddableURLParamsBmGroupKeyOverride{metronome.V1DashboardGetEmbeddableURLParamsBmGroupKeyOverride{
    ...
    ColorOverrides: []metronome.V1DashboardGetEmbeddableURLParamsColorOverride{metronome.V1DashboardGetEmbeddableURLParamsColorOverride{
      Name: "Gray_dark",
      Value: metronome.String("#ff0000"),
    }},
    DashboardOptions: []metronome.V1DashboardGetEmbeddableURLParamsDashboardOption{metronome.V1DashboardGetEmbeddableURLParamsDashboardOption{
      Key: "show_zero_usage_line_items",
      Value: "false",
    }, metronome.V1DashboardGetEmbeddableURLParamsDashboardOption{
