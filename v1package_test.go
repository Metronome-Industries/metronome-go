...
func TestV1PackageNewWithOptionalParams(t *testing.T) {
  ...
  _, err := client.V1.Packages.New(context.TODO(), metronome.V1PackageNewParams{
    Name: "My package",
    Aliases: []metronome.V1PackageNewParamsAlias{metronome.V1PackageNewParamsAlias{
      Name: "name",
    ...
    Commits: []metronome.V1PackageNewParamsCommit{metronome.V1PackageNewParamsCommit{
      AccessSchedule: metronome.V1PackageNewParamsCommitAccessSchedule{
        ScheduleItems: []metronome.V1PackageNewParamsCommitAccessScheduleScheduleItem{metronome.V1PackageNewParamsCommitAccessScheduleScheduleItem{
          Amount: 0,
      ...
      InvoiceSchedule: metronome.V1PackageNewParamsCommitInvoiceSchedule{
        ScheduleItems: []metronome.V1PackageNewParamsCommitInvoiceScheduleScheduleItem{metronome.V1PackageNewParamsCommitInvoiceScheduleScheduleItem{
    ...
    Credits: []metronome.V1PackageNewParamsCredit{metronome.V1PackageNewParamsCredit{
      AccessSchedule: metronome.V1PackageNewParamsCreditAccessSchedule{
        ScheduleItems: []metronome.V1PackageNewParamsCreditAccessScheduleScheduleItem{metronome.V1PackageNewParamsCreditAccessScheduleScheduleItem{
          Amount: 0,
    ...
    ContractOverrides: []metronome.V1PackageNewParamsOverride{metronome.V1PackageNewParamsOverride{
      OverrideSpecifiers: []metronome.V1PackageNewParamsOverrideOverrideSpecifier{metronome.V1PackageNewParamsOverrideOverrideSpecifier{
      ...
      Priority: metronome.Float(0),
      Target: "COMMIT_RATE",
      Tiers: []metronome.V1PackageNewParamsOverrideTier{metronome.V1PackageNewParamsOverrideTier{
        Multiplier: 0,
        Size: metronome.Float(0),
      }},
      Type: "OVERWRITE",
    ...
    RecurringCommits: []metronome.V1PackageNewParamsRecurringCommit{metronome.V1PackageNewParamsRecurringCommit{
    ...
    RecurringCredits: []metronome.V1PackageNewParamsRecurringCredit{metronome.V1PackageNewParamsRecurringCredit{
    ...
    ScheduledCharges: []metronome.V1PackageNewParamsScheduledCharge{metronome.V1PackageNewParamsScheduledCharge{
      ProductID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
      Schedule: metronome.V1PackageNewParamsScheduledChargeSchedule{
        ScheduleItems: []metronome.V1PackageNewParamsScheduledChargeScheduleScheduleItem{metronome.V1PackageNewParamsScheduledChargeScheduleScheduleItem{
    ...
    SpendTrackers: []metronome.V1PackageNewParamsSpendTracker{metronome.V1PackageNewParamsSpendTracker{
      Alias: "alias",
      ApplicableSpendSpecifiers: []metronome.V1PackageNewParamsSpendTrackerApplicableSpendSpecifier{metronome.V1PackageNewParamsSpendTrackerApplicableSpendSpecifier{
    ...
    Subscriptions: []metronome.V1PackageNewParamsSubscription{metronome.V1PackageNewParamsSubscription{
