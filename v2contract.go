...
type V2ContractGetResponseDataSubscription struct {
	...
	QuantityManagementMode V2ContractGetResponseDataSubscriptionsQuantityManagementMode `json:"quantity_management_mode,required"`
...
// directly on the subscription. `initial_quantity` must be provided with this
// option. Compatible with recurring commits/credits that use POOLED allocation.
type V2ContractGetResponseDataSubscriptionsQuantityManagementMode string

const (
	V2ContractGetResponseDataSubscriptionsQuantityManagementModeSeatBased    V2ContractGetResponseDataSubscriptionsQuantityManagementMode = "SEAT_BASED"
	V2ContractGetResponseDataSubscriptionsQuantityManagementModeQuantityOnly V2ContractGetResponseDataSubscriptionsQuantityManagementMode = "QUANTITY_ONLY"
)

func (r V2ContractGetResponseDataSubscriptionsQuantityManagementMode) IsKnown() bool {
	switch r {
	case V2ContractGetResponseDataSubscriptionsQuantityManagementModeSeatBased, V2ContractGetResponseDataSubscriptionsQuantityManagementModeQuantityOnly:
		return true
	}
	return false
}
...
type V2ContractListResponseDataSubscription struct {
	...
	// directly on the subscription. `initial_quantity` must be provided with this
	// option. Compatible with recurring commits/credits that use POOLED allocation.
	QuantityManagementMode V2ContractListResponseDataSubscriptionsQuantityManagementMode `json:"quantity_management_mode,required"`
	// List of quantity schedule items for the subscription. Only includes the current
	// quantity and future quantity changes.
...
// directly on the subscription. `initial_quantity` must be provided with this
// option. Compatible with recurring commits/credits that use POOLED allocation.
type V2ContractListResponseDataSubscriptionsQuantityManagementMode string

const (
	V2ContractListResponseDataSubscriptionsQuantityManagementModeSeatBased    V2ContractListResponseDataSubscriptionsQuantityManagementMode = "SEAT_BASED"
	V2ContractListResponseDataSubscriptionsQuantityManagementModeQuantityOnly V2ContractListResponseDataSubscriptionsQuantityManagementMode = "QUANTITY_ONLY"
)

func (r V2ContractListResponseDataSubscriptionsQuantityManagementMode) IsKnown() bool {
	switch r {
	case V2ContractListResponseDataSubscriptionsQuantityManagementModeSeatBased, V2ContractListResponseDataSubscriptionsQuantityManagementModeQuantityOnly:
		return true
	}
	return false
}
...
type V2ContractGetEditHistoryResponseDataAddSubscription struct {
	...
	// directly on the subscription. `initial_quantity` must be provided with this
	// option. Compatible with recurring commits/credits that use POOLED allocation.
	QuantityManagementMode V2ContractGetEditHistoryResponseDataAddSubscriptionsQuantityManagementMode `json:"quantity_management_mode,required"`
	// List of quantity schedule items for the subscription. Only includes the current
	// quantity and future quantity changes.
...
// directly on the subscription. `initial_quantity` must be provided with this
// option. Compatible with recurring commits/credits that use POOLED allocation.
type V2ContractGetEditHistoryResponseDataAddSubscriptionsQuantityManagementMode string

const (
	V2ContractGetEditHistoryResponseDataAddSubscriptionsQuantityManagementModeSeatBased    V2ContractGetEditHistoryResponseDataAddSubscriptionsQuantityManagementMode = "SEAT_BASED"
	V2ContractGetEditHistoryResponseDataAddSubscriptionsQuantityManagementModeQuantityOnly V2ContractGetEditHistoryResponseDataAddSubscriptionsQuantityManagementMode = "QUANTITY_ONLY"
)

func (r V2ContractGetEditHistoryResponseDataAddSubscriptionsQuantityManagementMode) IsKnown() bool {
	switch r {
	case V2ContractGetEditHistoryResponseDataAddSubscriptionsQuantityManagementModeSeatBased, V2ContractGetEditHistoryResponseDataAddSubscriptionsQuantityManagementModeQuantityOnly:
		return true
	}
	return false
}
