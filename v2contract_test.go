...
func TestV2ContractEditWithOptionalParams(t *testing.T) {
  ...
  _, err := client.V2.Contracts.Edit(context.TODO(), metronome.V2ContractEditParams{
    ...
    AddCommits: []metronome.V2ContractEditParamsAddCommit{metronome.V2ContractEditParamsAddCommit{
      ProductID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
      Type: "PREPAID",
      AccessSchedule: metronome.V2ContractEditParamsAddCommitAccessSchedule{
        ScheduleItems: []metronome.V2ContractEditParamsAddCommitAccessScheduleScheduleItem{metronome.V2ContractEditParamsAddCommitAccessScheduleScheduleItem{
          Amount: 0,
      ...
      InvoiceSchedule: metronome.V2ContractEditParamsAddCommitInvoiceSchedule{
        ...
        ScheduleItems: []metronome.V2ContractEditParamsAddCommitInvoiceScheduleScheduleItem{metronome.V2ContractEditParamsAddCommitInvoiceScheduleScheduleItem{
          Timestamp: time.Now(),
          Amount: metronome.Float(0),
          Quantity: metronome.Float(0),
          UnitPrice: metronome.Float(0),
      ...
      Specifiers: []shared.CommitSpecifierInputParam{shared.CommitSpecifierInputParam{
    ...
    AddCredits: []metronome.V2ContractEditParamsAddCredit{metronome.V2ContractEditParamsAddCredit{
      AccessSchedule: metronome.V2ContractEditParamsAddCreditAccessSchedule{
        ScheduleItems: []metronome.V2ContractEditParamsAddCreditAccessScheduleScheduleItem{metronome.V2ContractEditParamsAddCreditAccessScheduleScheduleItem{
          Amount: 0,
          EndingBefore: time.Now(),
          StartingAt: time.Now(),
        }},
    ...
    AddDiscounts: []metronome.V2ContractEditParamsAddDiscount{metronome.V2ContractEditParamsAddDiscount{
      ProductID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
      Schedule: metronome.V2ContractEditParamsAddDiscountSchedule{
        ...
        ScheduleItems: []metronome.V2ContractEditParamsAddDiscountScheduleScheduleItem{metronome.V2ContractEditParamsAddDiscountScheduleScheduleItem{
          Timestamp: time.Now(),
          Amount: metronome.Float(0),
          Quantity: metronome.Float(0),
          UnitPrice: metronome.Float(0),
    ...
    AddOverrides: []metronome.V2ContractEditParamsAddOverride{metronome.V2ContractEditParamsAddOverride{
      StartingAt: time.Now(),
      ApplicableProductTags: []string{"string"},
      ...
      OverrideSpecifiers: []metronome.V2ContractEditParamsAddOverrideOverrideSpecifier{metronome.V2ContractEditParamsAddOverrideOverrideSpecifier{
      ...
      OverwriteRate: metronome.V2ContractEditParamsAddOverrideOverwriteRate{
        ...
        Quantity: metronome.Float(0),
        Tiers: []shared.TierParam{shared.TierParam{
          Price: 0,
      ...
      Target: "COMMIT_RATE",
      Tiers: []metronome.V2ContractEditParamsAddOverrideTier{metronome.V2ContractEditParamsAddOverrideTier{
        Multiplier: 0,
        Size: metronome.Float(0),
      }},
      Type: "MULTIPLIER",
    ...
    AddPrepaidBalanceThresholdConfiguration: shared.PrepaidBalanceThresholdConfigurationV2Param{
      ...
      ThresholdBalanceSpecifiers: []shared.PrepaidBalanceThresholdConfigurationV2ThresholdBalanceSpecifierParam{shared.PrepaidBalanceThresholdConfigurationV2ThresholdBalanceSpecifierParam{
        Exclude: []shared.PrepaidBalanceThresholdConfigurationV2ThresholdBalanceSpecifierExcludeParam{shared.PrepaidBalanceThresholdConfigurationV2ThresholdBalanceSpecifierExcludeParam{
          CustomFieldFilters: []shared.PrepaidBalanceThresholdConfigurationV2ThresholdBalanceSpecifierExcludeCustomFieldFilterParam{shared.PrepaidBalanceThresholdConfigurationV2ThresholdBalanceSpecifierExcludeCustomFieldFilterParam{
            Entity: "Commit",
            Key: "key",
            Value: "value",
          }},
    ...
    AddProfessionalServices: []metronome.V2ContractEditParamsAddProfessionalService{metronome.V2ContractEditParamsAddProfessionalService{
      MaxAmount: 0,
      ProductID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
      Quantity: 0,
      UnitPrice: 0,
    ...
    AddRecurringCommits: []metronome.V2ContractEditParamsAddRecurringCommit{metronome.V2ContractEditParamsAddRecurringCommit{
    ...
    AddRecurringCredits: []metronome.V2ContractEditParamsAddRecurringCredit{metronome.V2ContractEditParamsAddRecurringCredit{
    ...
    AddResellerRoyalties: []metronome.V2ContractEditParamsAddResellerRoyalty{metronome.V2ContractEditParamsAddResellerRoyalty{
      ResellerType: "AWS",
      ApplicableProductIDs: []string{"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"},
      ApplicableProductTags: []string{"string"},
    ...
    AddScheduledCharges: []metronome.V2ContractEditParamsAddScheduledCharge{metronome.V2ContractEditParamsAddScheduledCharge{
      ...
      Schedule: metronome.V2ContractEditParamsAddScheduledChargeSchedule{
        ...
        ScheduleItems: []metronome.V2ContractEditParamsAddScheduledChargeScheduleScheduleItem{metronome.V2ContractEditParamsAddScheduledChargeScheduleScheduleItem{
          Timestamp: time.Now(),
          Amount: metronome.Float(0),
    ...
    AddSpendTrackers: []metronome.V2ContractEditParamsAddSpendTracker{metronome.V2ContractEditParamsAddSpendTracker{
      Alias: "alias",
      ApplicableSpendSpecifiers: []metronome.V2ContractEditParamsAddSpendTrackerApplicableSpendSpecifier{metronome.V2ContractEditParamsAddSpendTrackerApplicableSpendSpecifier{
    ...
    AddSubscriptions: []metronome.V2ContractEditParamsAddSubscription{metronome.V2ContractEditParamsAddSubscription{
    ...
    ArchiveCommits: []metronome.V2ContractEditParamsArchiveCommit{metronome.V2ContractEditParamsArchiveCommit{
      ID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    }},
    ArchiveCredits: []metronome.V2ContractEditParamsArchiveCredit{metronome.V2ContractEditParamsArchiveCredit{
      ID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    }},
    ArchiveScheduledCharges: []metronome.V2ContractEditParamsArchiveScheduledCharge{metronome.V2ContractEditParamsArchiveScheduledCharge{
      ID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    }},
    ArchiveSpendTrackers: []string{"string"},
    RemoveOverrides: []metronome.V2ContractEditParamsRemoveOverride{metronome.V2ContractEditParamsRemoveOverride{
      ID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    }},
    UniquenessKey: metronome.String("x"),
    UpdateCommits: []metronome.V2ContractEditParamsUpdateCommit{metronome.V2ContractEditParamsUpdateCommit{
      CommitID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
      AccessSchedule: metronome.V2ContractEditParamsUpdateCommitAccessSchedule{
        AddScheduleItems: []metronome.V2ContractEditParamsUpdateCommitAccessScheduleAddScheduleItem{metronome.V2ContractEditParamsUpdateCommitAccessScheduleAddScheduleItem{
          Amount: 0,
          EndingBefore: time.Now(),
          StartingAt: time.Now(),
        }},
        RemoveScheduleItems: []metronome.V2ContractEditParamsUpdateCommitAccessScheduleRemoveScheduleItem{metronome.V2ContractEditParamsUpdateCommitAccessScheduleRemoveScheduleItem{
          ID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        }},
        UpdateScheduleItems: []metronome.V2ContractEditParamsUpdateCommitAccessScheduleUpdateScheduleItem{metronome.V2ContractEditParamsUpdateCommitAccessScheduleUpdateScheduleItem{
          ID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
          Amount: metronome.Float(0),
          EndingBefore: metronome.Time(time.Now()),
          StartingAt: metronome.Time(time.Now()),
      ...
      InvoiceSchedule: metronome.V2ContractEditParamsUpdateCommitInvoiceSchedule{
        AddScheduleItems: []metronome.V2ContractEditParamsUpdateCommitInvoiceScheduleAddScheduleItem{metronome.V2ContractEditParamsUpdateCommitInvoiceScheduleAddScheduleItem{
          Timestamp: time.Now(),
          Amount: metronome.Float(0),
          Quantity: metronome.Float(0),
          UnitPrice: metronome.Float(0),
        }},
        RemoveScheduleItems: []metronome.V2ContractEditParamsUpdateCommitInvoiceScheduleRemoveScheduleItem{metronome.V2ContractEditParamsUpdateCommitInvoiceScheduleRemoveScheduleItem{
          ID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        }},
        UpdateScheduleItems: []metronome.V2ContractEditParamsUpdateCommitInvoiceScheduleUpdateScheduleItem{metronome.V2ContractEditParamsUpdateCommitInvoiceScheduleUpdateScheduleItem{
          ID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
          Amount: metronome.Float(0),
          Quantity: metronome.Float(0),
    ...
    UpdateCredits: []metronome.V2ContractEditParamsUpdateCredit{metronome.V2ContractEditParamsUpdateCredit{
      CreditID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
      AccessSchedule: metronome.V2ContractEditParamsUpdateCreditAccessSchedule{
        AddScheduleItems: []metronome.V2ContractEditParamsUpdateCreditAccessScheduleAddScheduleItem{metronome.V2ContractEditParamsUpdateCreditAccessScheduleAddScheduleItem{
          Amount: 0,
          EndingBefore: time.Now(),
          StartingAt: time.Now(),
        }},
        RemoveScheduleItems: []metronome.V2ContractEditParamsUpdateCreditAccessScheduleRemoveScheduleItem{metronome.V2ContractEditParamsUpdateCreditAccessScheduleRemoveScheduleItem{
          ID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        }},
        UpdateScheduleItems: []metronome.V2ContractEditParamsUpdateCreditAccessScheduleUpdateScheduleItem{metronome.V2ContractEditParamsUpdateCreditAccessScheduleUpdateScheduleItem{
          ID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
          Amount: metronome.Float(0),
          EndingBefore: metronome.Time(time.Now()),
          StartingAt: metronome.Time(time.Now()),
    ...
    UpdatePrepaidBalanceThresholdConfiguration: metronome.V2ContractEditParamsUpdatePrepaidBalanceThresholdConfiguration{
      ...
      ThresholdBalanceSpecifiers: []metronome.V2ContractEditParamsUpdatePrepaidBalanceThresholdConfigurationThresholdBalanceSpecifier{metronome.V2ContractEditParamsUpdatePrepaidBalanceThresholdConfigurationThresholdBalanceSpecifier{
        Exclude: []metronome.V2ContractEditParamsUpdatePrepaidBalanceThresholdConfigurationThresholdBalanceSpecifierExclude{metronome.V2ContractEditParamsUpdatePrepaidBalanceThresholdConfigurationThresholdBalanceSpecifierExclude{
          CustomFieldFilters: []metronome.V2ContractEditParamsUpdatePrepaidBalanceThresholdConfigurationThresholdBalanceSpecifierExcludeCustomFieldFilter{metronome.V2ContractEditParamsUpdatePrepaidBalanceThresholdConfigurationThresholdBalanceSpecifierExcludeCustomFieldFilter{
            Entity: "Commit",
            Key: "key",
            Value: "value",
          }},
    ...
    UpdateRecurringCommits: []metronome.V2ContractEditParamsUpdateRecurringCommit{metronome.V2ContractEditParamsUpdateRecurringCommit{
    ...
    UpdateRecurringCredits: []metronome.V2ContractEditParamsUpdateRecurringCredit{metronome.V2ContractEditParamsUpdateRecurringCredit{
    ...
    UpdateScheduledCharges: []metronome.V2ContractEditParamsUpdateScheduledCharge{metronome.V2ContractEditParamsUpdateScheduledCharge{
      ...
      InvoiceSchedule: metronome.V2ContractEditParamsUpdateScheduledChargeInvoiceSchedule{
        AddScheduleItems: []metronome.V2ContractEditParamsUpdateScheduledChargeInvoiceScheduleAddScheduleItem{metronome.V2ContractEditParamsUpdateScheduledChargeInvoiceScheduleAddScheduleItem{
          Timestamp: time.Now(),
          Amount: metronome.Float(0),
          Quantity: metronome.Float(0),
          UnitPrice: metronome.Float(0),
        }},
        RemoveScheduleItems: []metronome.V2ContractEditParamsUpdateScheduledChargeInvoiceScheduleRemoveScheduleItem{metronome.V2ContractEditParamsUpdateScheduledChargeInvoiceScheduleRemoveScheduleItem{
          ID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        }},
        UpdateScheduleItems: []metronome.V2ContractEditParamsUpdateScheduledChargeInvoiceScheduleUpdateScheduleItem{metronome.V2ContractEditParamsUpdateScheduledChargeInvoiceScheduleUpdateScheduleItem{
          ID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
          Amount: metronome.Float(0),
          Quantity: metronome.Float(0),
          Timestamp: metronome.Time(time.Now()),
    ...
    UpdateSubscriptions: []metronome.V2ContractEditParamsUpdateSubscription{metronome.V2ContractEditParamsUpdateSubscription{
      ...
      QuantityUpdates: []metronome.V2ContractEditParamsUpdateSubscriptionQuantityUpdate{metronome.V2ContractEditParamsUpdateSubscriptionQuantityUpdate{
        StartingAt: time.Now(),
        Quantity: metronome.Float(0),
        QuantityDelta: metronome.Float(0),
      }},
      SeatUpdates: metronome.V2ContractEditParamsUpdateSubscriptionSeatUpdates{
        AddSeatIDs: []metronome.V2ContractEditParamsUpdateSubscriptionSeatUpdatesAddSeatID{metronome.V2ContractEditParamsUpdateSubscriptionSeatUpdatesAddSeatID{
          SeatIDs: []string{"string"},
          StartingAt: time.Now(),
        }},
        AddUnassignedSeats: []metronome.V2ContractEditParamsUpdateSubscriptionSeatUpdatesAddUnassignedSeat{metronome.V2ContractEditParamsUpdateSubscriptionSeatUpdatesAddUnassignedSeat{
          Quantity: 1,
          StartingAt: time.Now(),
        }},
        RemoveSeatIDs: []metronome.V2ContractEditParamsUpdateSubscriptionSeatUpdatesRemoveSeatID{metronome.V2ContractEditParamsUpdateSubscriptionSeatUpdatesRemoveSeatID{
          SeatIDs: []string{"string"},
          StartingAt: time.Now(),
        }},
        RemoveUnassignedSeats: []metronome.V2ContractEditParamsUpdateSubscriptionSeatUpdatesRemoveUnassignedSeat{metronome.V2ContractEditParamsUpdateSubscriptionSeatUpdatesRemoveUnassignedSeat{
          Quantity: 1,
          StartingAt: time.Now(),
        }},
      },
...
func TestV2ContractEditCommitWithOptionalParams(t *testing.T) {
  ...
  _, err := client.V2.Contracts.EditCommit(context.TODO(), metronome.V2ContractEditCommitParams{
    ...
    AccessSchedule: metronome.V2ContractEditCommitParamsAccessSchedule{
      AddScheduleItems: []metronome.V2ContractEditCommitParamsAccessScheduleAddScheduleItem{metronome.V2ContractEditCommitParamsAccessScheduleAddScheduleItem{
        Amount: 0,
        EndingBefore: time.Now(),
        StartingAt: time.Now(),
      }},
      RemoveScheduleItems: []metronome.V2ContractEditCommitParamsAccessScheduleRemoveScheduleItem{metronome.V2ContractEditCommitParamsAccessScheduleRemoveScheduleItem{
        ID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
      }},
      UpdateScheduleItems: []metronome.V2ContractEditCommitParamsAccessScheduleUpdateScheduleItem{metronome.V2ContractEditCommitParamsAccessScheduleUpdateScheduleItem{
    ...
    ApplicableContractIDs: []string{"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"},
    ApplicableProductIDs: []string{"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"},
    ApplicableProductTags: []string{"string"},
    Description: metronome.String("description"),
    HierarchyConfiguration: shared.CommitHierarchyConfigurationParam{
    ...
    InvoiceSchedule: metronome.V2ContractEditCommitParamsInvoiceSchedule{
      AddScheduleItems: []metronome.V2ContractEditCommitParamsInvoiceScheduleAddScheduleItem{metronome.V2ContractEditCommitParamsInvoiceScheduleAddScheduleItem{
        Timestamp: time.Now(),
        Amount: metronome.Float(0),
        Quantity: metronome.Float(0),
        UnitPrice: metronome.Float(0),
      }},
      RemoveScheduleItems: []metronome.V2ContractEditCommitParamsInvoiceScheduleRemoveScheduleItem{metronome.V2ContractEditCommitParamsInvoiceScheduleRemoveScheduleItem{
        ID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
      }},
      UpdateScheduleItems: []metronome.V2ContractEditCommitParamsInvoiceScheduleUpdateScheduleItem{metronome.V2ContractEditCommitParamsInvoiceScheduleUpdateScheduleItem{
        ID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        Amount: metronome.Float(0),
        Quantity: metronome.Float(0),
        Timestamp: metronome.Time(time.Now()),
...
func TestV2ContractEditCreditWithOptionalParams(t *testing.T) {
  ...
  _, err := client.V2.Contracts.EditCredit(context.TODO(), metronome.V2ContractEditCreditParams{
    ...
    AccessSchedule: metronome.V2ContractEditCreditParamsAccessSchedule{
      AddScheduleItems: []metronome.V2ContractEditCreditParamsAccessScheduleAddScheduleItem{metronome.V2ContractEditCreditParamsAccessScheduleAddScheduleItem{
        Amount: 0,
        EndingBefore: time.Now(),
        StartingAt: time.Now(),
      }},
      RemoveScheduleItems: []metronome.V2ContractEditCreditParamsAccessScheduleRemoveScheduleItem{metronome.V2ContractEditCreditParamsAccessScheduleRemoveScheduleItem{
        ID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
      }},
      UpdateScheduleItems: []metronome.V2ContractEditCreditParamsAccessScheduleUpdateScheduleItem{metronome.V2ContractEditCreditParamsAccessScheduleUpdateScheduleItem{
        ID: "d5edbd32-c744-48cb-9475-a9bca0e6fa39",
        Amount: metronome.Float(0),
        EndingBefore: metronome.Time(time.Now()),
        StartingAt: metronome.Time(time.Now()),
