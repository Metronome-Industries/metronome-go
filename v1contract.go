...
func (r *V1ContractService) ListBalances(ctx context.Context, body V1ContractListBalancesParams, opts ...option.RequestOption) (res *pagination.CursorPage[V1ContractListBalancesResponse], err error) {
...
// List balances (commits and credits).
func (r *V1ContractService) ListBalancesAutoPaging(ctx context.Context, body V1ContractListBalancesParams, opts ...option.RequestOption) *pagination.CursorPageAutoPager[V1ContractListBalancesResponse] {
	return pagination.NewCursorPageAutoPager(r.ListBalances(ctx, body, opts...))
}
