...
type V1ContractGetResponseDataCurrent struct {
	...
	ThresholdBillingConfiguration   V1ContractGetResponseDataCurrentThresholdBillingConfiguration   `json:"threshold_billing_configuration"`
	// This field's availability is dependent on your client's configuration.
...
type V1ContractGetResponseDataCurrentThresholdBillingConfiguration struct {
	Commit V1ContractGetResponseDataCurrentThresholdBillingConfigurationCommit `json:"commit,required"`
	...
	JSON            v1ContractGetResponseDataCurrentThresholdBillingConfigurationJSON `json:"-"`
}

// v1ContractGetResponseDataCurrentThresholdBillingConfigurationJSON contains the
// JSON metadata for the struct
// [V1ContractGetResponseDataCurrentThresholdBillingConfiguration]
type v1ContractGetResponseDataCurrentThresholdBillingConfigurationJSON struct {
...
func (r *V1ContractGetResponseDataCurrentThresholdBillingConfiguration) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r v1ContractGetResponseDataCurrentThresholdBillingConfigurationJSON) RawJSON() string {
	return r.raw
}

type V1ContractGetResponseDataCurrentThresholdBillingConfigurationCommit struct {
	...
	Name string                                                                  `json:"name"`
	JSON v1ContractGetResponseDataCurrentThresholdBillingConfigurationCommitJSON `json:"-"`
}

// v1ContractGetResponseDataCurrentThresholdBillingConfigurationCommitJSON contains
// the JSON metadata for the struct
// [V1ContractGetResponseDataCurrentThresholdBillingConfigurationCommit]
type v1ContractGetResponseDataCurrentThresholdBillingConfigurationCommitJSON struct {
	ProductID             apijson.Field
	ApplicableProductIDs  apijson.Field
	ApplicableProductTags apijson.Field
	Description           apijson.Field
...
func (r *V1ContractGetResponseDataCurrentThresholdBillingConfigurationCommit) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r v1ContractGetResponseDataCurrentThresholdBillingConfigurationCommitJSON) RawJSON() string {
	return r.raw
}
...
type V1ContractGetResponseDataInitial struct {
	...
	ThresholdBillingConfiguration   V1ContractGetResponseDataInitialThresholdBillingConfiguration   `json:"threshold_billing_configuration"`
	// This field's availability is dependent on your client's configuration.
	TotalContractValue float64                                     `json:"total_contract_value"`
...
type V1ContractGetResponseDataInitialThresholdBillingConfiguration struct {
	Commit V1ContractGetResponseDataInitialThresholdBillingConfigurationCommit `json:"commit,required"`
	// When set to false, the contract will not be evaluated against the
	// threshold_amount. Toggling to true will result an immediate evaluation,
	// regardless of prior state
	IsEnabled bool `json:"is_enabled,required"`
	...
	// hits this amount, a threshold charge will be initiated.
	ThresholdAmount float64                                                           `json:"threshold_amount,required"`
	JSON            v1ContractGetResponseDataInitialThresholdBillingConfigurationJSON `json:"-"`
}

// v1ContractGetResponseDataInitialThresholdBillingConfigurationJSON contains the
// JSON metadata for the struct
// [V1ContractGetResponseDataInitialThresholdBillingConfiguration]
type v1ContractGetResponseDataInitialThresholdBillingConfigurationJSON struct {
	Commit          apijson.Field
	IsEnabled       apijson.Field
	ThresholdAmount apijson.Field
	raw             string
...
func (r *V1ContractGetResponseDataInitialThresholdBillingConfiguration) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r v1ContractGetResponseDataInitialThresholdBillingConfigurationJSON) RawJSON() string {
	return r.raw
}

type V1ContractGetResponseDataInitialThresholdBillingConfigurationCommit struct {
	ProductID string `json:"product_id,required"`
	// Which products the threshold commit applies to. If both applicable_product_ids
	// and applicable_product_tags are not provided, the commit applies to all
	// products.
	...
	// will default to the commit product name.
	Name string                                                                  `json:"name"`
	JSON v1ContractGetResponseDataInitialThresholdBillingConfigurationCommitJSON `json:"-"`
}

// v1ContractGetResponseDataInitialThresholdBillingConfigurationCommitJSON contains
// the JSON metadata for the struct
// [V1ContractGetResponseDataInitialThresholdBillingConfigurationCommit]
type v1ContractGetResponseDataInitialThresholdBillingConfigurationCommitJSON struct {
	ProductID             apijson.Field
	ApplicableProductIDs  apijson.Field
	ApplicableProductTags apijson.Field
	Description           apijson.Field
...
func (r *V1ContractGetResponseDataInitialThresholdBillingConfigurationCommit) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r v1ContractGetResponseDataInitialThresholdBillingConfigurationCommitJSON) RawJSON() string {
	return r.raw
}
...
type V1ContractListResponseDataCurrent struct {
	...
	ThresholdBillingConfiguration   V1ContractListResponseDataCurrentThresholdBillingConfiguration   `json:"threshold_billing_configuration"`
	// This field's availability is dependent on your client's configuration.
	TotalContractValue float64                                      `json:"total_contract_value"`
...
type V1ContractListResponseDataCurrentThresholdBillingConfiguration struct {
	Commit V1ContractListResponseDataCurrentThresholdBillingConfigurationCommit `json:"commit,required"`
	// When set to false, the contract will not be evaluated against the
	// threshold_amount. Toggling to true will result an immediate evaluation,
	// regardless of prior state
	IsEnabled bool `json:"is_enabled,required"`
	...
	// hits this amount, a threshold charge will be initiated.
	ThresholdAmount float64                                                            `json:"threshold_amount,required"`
	JSON            v1ContractListResponseDataCurrentThresholdBillingConfigurationJSON `json:"-"`
}

// v1ContractListResponseDataCurrentThresholdBillingConfigurationJSON contains the
// JSON metadata for the struct
// [V1ContractListResponseDataCurrentThresholdBillingConfiguration]
type v1ContractListResponseDataCurrentThresholdBillingConfigurationJSON struct {
	Commit          apijson.Field
	IsEnabled       apijson.Field
	ThresholdAmount apijson.Field
	raw             string
...
func (r *V1ContractListResponseDataCurrentThresholdBillingConfiguration) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r v1ContractListResponseDataCurrentThresholdBillingConfigurationJSON) RawJSON() string {
	return r.raw
}

type V1ContractListResponseDataCurrentThresholdBillingConfigurationCommit struct {
	ProductID string `json:"product_id,required"`
	// Which products the threshold commit applies to. If both applicable_product_ids
	// and applicable_product_tags are not provided, the commit applies to all
	// products.
	...
	// will default to the commit product name.
	Name string                                                                   `json:"name"`
	JSON v1ContractListResponseDataCurrentThresholdBillingConfigurationCommitJSON `json:"-"`
}

// v1ContractListResponseDataCurrentThresholdBillingConfigurationCommitJSON
// contains the JSON metadata for the struct
// [V1ContractListResponseDataCurrentThresholdBillingConfigurationCommit]
type v1ContractListResponseDataCurrentThresholdBillingConfigurationCommitJSON struct {
	ProductID             apijson.Field
	ApplicableProductIDs  apijson.Field
	ApplicableProductTags apijson.Field
	Description           apijson.Field
...
func (r *V1ContractListResponseDataCurrentThresholdBillingConfigurationCommit) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r v1ContractListResponseDataCurrentThresholdBillingConfigurationCommitJSON) RawJSON() string {
	return r.raw
}
...
type V1ContractListResponseDataInitial struct {
	...
	ThresholdBillingConfiguration   V1ContractListResponseDataInitialThresholdBillingConfiguration   `json:"threshold_billing_configuration"`
	// This field's availability is dependent on your client's configuration.
	TotalContractValue float64                                      `json:"total_contract_value"`
...
type V1ContractListResponseDataInitialThresholdBillingConfiguration struct {
	Commit V1ContractListResponseDataInitialThresholdBillingConfigurationCommit `json:"commit,required"`
	// When set to false, the contract will not be evaluated against the
	// threshold_amount. Toggling to true will result an immediate evaluation,
	// regardless of prior state
	IsEnabled bool `json:"is_enabled,required"`
	...
	// hits this amount, a threshold charge will be initiated.
	ThresholdAmount float64                                                            `json:"threshold_amount,required"`
	JSON            v1ContractListResponseDataInitialThresholdBillingConfigurationJSON `json:"-"`
}

// v1ContractListResponseDataInitialThresholdBillingConfigurationJSON contains the
// JSON metadata for the struct
// [V1ContractListResponseDataInitialThresholdBillingConfiguration]
type v1ContractListResponseDataInitialThresholdBillingConfigurationJSON struct {
	Commit          apijson.Field
	IsEnabled       apijson.Field
	ThresholdAmount apijson.Field
	raw             string
...
func (r *V1ContractListResponseDataInitialThresholdBillingConfiguration) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r v1ContractListResponseDataInitialThresholdBillingConfigurationJSON) RawJSON() string {
	return r.raw
}

type V1ContractListResponseDataInitialThresholdBillingConfigurationCommit struct {
	ProductID string `json:"product_id,required"`
	// Which products the threshold commit applies to. If both applicable_product_ids
	// and applicable_product_tags are not provided, the commit applies to all
	// products.
	...
	// will default to the commit product name.
	Name string                                                                   `json:"name"`
	JSON v1ContractListResponseDataInitialThresholdBillingConfigurationCommitJSON `json:"-"`
}

// v1ContractListResponseDataInitialThresholdBillingConfigurationCommitJSON
// contains the JSON metadata for the struct
// [V1ContractListResponseDataInitialThresholdBillingConfigurationCommit]
type v1ContractListResponseDataInitialThresholdBillingConfigurationCommitJSON struct {
	ProductID             apijson.Field
	ApplicableProductIDs  apijson.Field
	ApplicableProductTags apijson.Field
	Description           apijson.Field
...
func (r *V1ContractListResponseDataInitialThresholdBillingConfigurationCommit) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r v1ContractListResponseDataInitialThresholdBillingConfigurationCommitJSON) RawJSON() string {
	return r.raw
}
