...
func TestV1CustomerNewWithOptionalParams(t *testing.T) {
  ...
  _, err := client.V1.Customers.New(context.TODO(), metronome.V1CustomerNewParams{
    ...
    CustomerBillingProviderConfigurations: []metronome.V1CustomerNewParamsCustomerBillingProviderConfiguration{metronome.V1CustomerNewParamsCustomerBillingProviderConfiguration{
    ...
    CustomerRevenueSystemConfigurations: []metronome.V1CustomerNewParamsCustomerRevenueSystemConfiguration{metronome.V1CustomerNewParamsCustomerRevenueSystemConfiguration{
      Provider: "netsuite",
      Configuration: map[string]any{
      "foo": "bar",
      },
...
func TestV1CustomerArchiveBillingConfigurations(t *testing.T) {
  baseURL := "http://localhost:4010"
  if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
    baseURL = envURL
  }
  ...
  _, err := client.V1.Customers.ArchiveBillingConfigurations(context.TODO(), metronome.V1CustomerArchiveBillingConfigurationsParams{
    CustomerBillingProviderConfigurationIDs: []string{"4db51251-61de-4bfe-b9ce-495e244f3491", "4db51251-61de-4bfe-b9ce-495e244f3491"},
...
func TestV1CustomerPreviewEventsWithOptionalParams(t *testing.T) {
  ...
  _, err := client.V1.Customers.PreviewEvents(context.TODO(), metronome.V1CustomerPreviewEventsParams{
    CustomerID: "d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
    Events: []metronome.V1CustomerPreviewEventsParamsEvent{metronome.V1CustomerPreviewEventsParamsEvent{
      EventType: "heartbeat",
...
func TestV1CustomerSetBillingConfigurations(t *testing.T) {
  ...
  _, err := client.V1.Customers.SetBillingConfigurations(context.TODO(), metronome.V1CustomerSetBillingConfigurationsParams{
    Data: []metronome.V1CustomerSetBillingConfigurationsParamsData{metronome.V1CustomerSetBillingConfigurationsParamsData{
      BillingProvider: "stripe",
      ...
      DeliveryMethodID: metronome.String("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
      TaxProvider: "anrok",
    }, metronome.V1CustomerSetBillingConfigurationsParamsData{
