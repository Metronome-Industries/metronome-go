...
func TestV1AlertNewWithOptionalParams(t *testing.T) {
  ...
  _, err := client.V1.Alerts.New(context.TODO(), metronome.V1AlertNewParams{
    ...
    Threshold: 10000,
    AlertSpecifiers: []metronome.V1AlertNewParamsAlertSpecifier{metronome.V1AlertNewParamsAlertSpecifier{
      CustomFieldFilters: []metronome.V1AlertNewParamsAlertSpecifierCustomFieldFilter{metronome.V1AlertNewParamsAlertSpecifierCustomFieldFilter{
        Entity: "Contract",
        Key: "key",
        Value: metronome.String("value"),
      }},
      Exclude: []metronome.V1AlertNewParamsAlertSpecifierExclude{metronome.V1AlertNewParamsAlertSpecifierExclude{
        CustomFieldFilters: []metronome.V1AlertNewParamsAlertSpecifierExcludeCustomFieldFilter{metronome.V1AlertNewParamsAlertSpecifierExcludeCustomFieldFilter{
          Entity: "Contract",
          Key: "key",
          Value: "value",
        }},
    ...
    CustomFieldFilters: []metronome.V1AlertNewParamsCustomFieldFilter{metronome.V1AlertNewParamsCustomFieldFilter{
      Entity: "Contract",
      Key: "key",
      Value: "value",
    }},
    ...
    GroupValues: []metronome.V1AlertNewParamsGroupValue{metronome.V1AlertNewParamsGroupValue{
      Key: "key",
      Value: metronome.String("value"),
    }},
