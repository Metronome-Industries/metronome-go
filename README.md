...
> [!WARNING]
> The 1.0.0 version of this package introduces a new design with significant breaking changes.
...
```sh
go get -u 'github.com/Metronome-Industries/metronome-go@v3.10.0'
```
